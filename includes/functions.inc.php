<?php
	...
	function createUser($conn, $name, $username, $password, $phone){
		$sql = "INSERT INTO customer (USERNAME, PASSWORD, CUS_NAME, PHONE) VALUES (?,?,?,?);";
		...
		mysqli_stmt_bind_param($stmt, "ssss", $username, $hashedPwd, $name, $phone);
		mysqli_stmt_execute($stmt);
